...
BUCKET_NAME = "de-zoomcamp-2026-bucket-8mk4m6r2d4gdresm"
...
COLORS = ["yellow", "green"]
YEARS = [f"{i:04d}" for i in range(2019, 2021)]
...
if __name__ == "__main__":
    ...
    combinations = list(product(COLORS, YEARS, MONTHS))

    with ThreadPoolExecutor(max_workers=4) as executor:
        file_paths = list(executor.map(download_file, [c[0] for c in combinations], [c[1] for c in combinations], [c[2] for c in combinations]))
